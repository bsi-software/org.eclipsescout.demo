...
public class EventManagementOutlineService extends AbstractService implements IEventManagementOutlineService {
  ...
  @Override
  public EventsTablePageData getEventsTableData(SearchFilter filter, String pageContactId) throws ProcessingException {
    ...
    SQL.selectInto(sql, new NVPair("pageContactId", pageContactId), new NVPair("page", pageData));
