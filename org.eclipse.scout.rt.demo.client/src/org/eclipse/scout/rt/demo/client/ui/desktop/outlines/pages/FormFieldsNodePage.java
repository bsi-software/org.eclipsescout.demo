...
//    pageList.add(formPage0);
    ...
    FormPage formPage3 = new FormPage(DateFieldForm.class);
    pageList.add(formPage3);
    FormPage formPage4 = new FormPage(FileChooserFieldForm.class);
    pageList.add(formPage4);
    FormPage formPage5 = new FormPage(GroupBoxForm.class);
    pageList.add(formPage5);
    FormPage formPage6 = new FormPage(HTMLFieldForm.class);
    pageList.add(formPage6);
    FormPage formPage7 = new FormPage(ImageFieldForm.class);
    pageList.add(formPage7);
    FormPage formPage8 = new FormPage(KeyStrokeForm.class);
    pageList.add(formPage8);
    FormPage formPage9 = new FormPage(LabelForm.class);
    pageList.add(formPage9);
    FormPage formPage10 = new FormPage(ListBoxForm.class);
    pageList.add(formPage10);
    FormPage formPage11 = new FormPage(MessageBoxesForm.class);
    pageList.add(formPage11);
    FormPage formPage12 = new FormPage(SVGFieldForm.class);
    pageList.add(formPage12);
    FormPage formPage13 = new FormPage(SmartFieldForm.class);
    pageList.add(formPage13);
    FormPage formPage14 = new FormPage(StatusForm.class);
    pageList.add(formPage14);
    FormPage formPage15 = new FormPage(TabBoxForm.class);
    pageList.add(formPage15);
    FormPage formPage16 = new FormPage(TableForm.class);
    pageList.add(formPage16);
    FormPage formPage17 = new FormPage(TreeBoxForm.class);
    pageList.add(formPage17);
    FormPage formPage18 = new FormPage(TreeFieldForm.class);
    pageList.add(formPage18);
    FormPage formPage19 = new FormPage(WrappedFormFieldForm.class);
