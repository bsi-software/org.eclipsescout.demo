...
public class FormFieldsNodePage extends AbstractPageWithNodes {
  ...
  protected void execCreateChildPages(Collection<IPage> pageList) throws ProcessingException {
    ...
    FormPage formPage14 = new FormPage(PlannerFieldForm.class);
    ...
    FormPage formPage17 = new FormPage(StringFieldForm.class);
    pageList.add(formPage17);
    FormPage formPage18 = new FormPage(SVGFieldForm.class);
    pageList.add(formPage18);
    FormPage formPage19 = new FormPage(TabBoxForm.class);
    pageList.add(formPage19);
    FormPage formPage20 = new FormPage(TableForm.class);
    pageList.add(formPage20);
    FormPage formPage21 = new FormPage(TreeBoxForm.class);
    pageList.add(formPage21);
    FormPage formPage22 = new FormPage(TreeFieldForm.class);
