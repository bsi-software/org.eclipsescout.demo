...
//    pageList.add(formPage6);
    ...
    FormPage formPage14 = new FormPage(HTMLFieldForm.class);
    pageList.add(formPage14);
    FormPage formPage15 = new FormPage(FileChooserFieldForm.class);
    pageList.add(formPage15);
    FormPage formPage16 = new FormPage(ListBoxForm.class);
