...
public class FormFieldsNodePage extends AbstractPageWithNodes {
  ...
  protected void execCreateChildPages(Collection<IPage> pageList) throws ProcessingException {
    ...
    FormPage formPage13 = new FormPage(MailFieldForm.class);
    pageList.add(formPage13);
    FormPage formPage14 = new FormPage(MessageBoxesForm.class);
    pageList.add(formPage14);
    FormPage formPage15 = new FormPage(PlannerFieldForm.class);
    pageList.add(formPage15);
    FormPage formPage16 = new FormPage(SmartFieldForm.class);
    pageList.add(formPage16);
    FormPage formPage17 = new FormPage(StatusForm.class);
    pageList.add(formPage17);
    FormPage formPage18 = new FormPage(StringFieldForm.class);
    pageList.add(formPage18);
    FormPage formPage19 = new FormPage(SVGFieldForm.class);
    pageList.add(formPage19);
    FormPage formPage20 = new FormPage(TabBoxForm.class);
    pageList.add(formPage20);
    FormPage formPage21 = new FormPage(TableForm.class);
    pageList.add(formPage21);
    FormPage formPage22 = new FormPage(TreeBoxForm.class);
    pageList.add(formPage22);
    FormPage formPage23 = new FormPage(TreeFieldForm.class);
    pageList.add(formPage23);
    FormPage formPage24 = new FormPage(WrappedFormFieldForm.class);
